<?php
$titulo = "Pesquisar Arquivo Morto"; // Título da pagina
...
<h2> Pesquisar determinado livro </h2>
<div class="filtros">
    <h2> Pesquisar por: </h2>
...
<form name="excluir_livro" method="post" class="form_pesquisar" onsubmit="return validar()" action="../../php/arq_morto/pesquisa_livro.php">

<?php
$titulo = "Listar Pessoa"; // Título da pagina
...
<button class="bt-voltar" onclick="window.location.href = 'menu_pessoas.html'"> Menu </button>
    ...
    <div class="filtros">
        <button type="button" class="bt-esc bt_filtro" onclick="muda(1)"> Lista de Pessoas por Turma </button>
    ...
    <form method="post" class="form_imprimir">
        ...
        <fieldset id="inadimplentes">
            <legend> Lista de Pessoas inadimplentes </legend>
            <label for="data"> Pessoas inadimplentes à </label>
            <div>
                <select name="diasPessoa">
...
<script>
    ...
    function muda(x) {
        ...
        if(x == 1) {
            document.getElementById("lista-pessoas").style.display = "flex";
            ...
            document.getElementById("lista-pessoas").style.display = "none";
            document.getElementById("leitores").style.display = "none";
        }
        else {

...
<html lang="pt-br">
  ...
  if(isset($_GET["periodo"])){
      ...
      $q = "SELECT l.titulo, count(l.idlivro) FROM livros as l join reglivros as r on l.idlivro = r.idlivro where r.situacao like 'e' and data > '$periodo' group by l.idlivro order by count(r.idlivro) desc limit $limit";

...
if(isset($_GET["nome"])){
    ...
    if($c != 0){
        ...
        for($x = 0; $x < count($data); $x++){
          ...
          echo "<input type='radio' name='escolha' value='$pessoa' id='$pessoa' onchange='respondeChecked()'> <label for='$pessoa'> $valor </label> <br>";
        }
    }else{echo "<p> Este nome não está registrado no banco de dados de pessoas!</p>";}
}else{}
